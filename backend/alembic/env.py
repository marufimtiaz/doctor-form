...
def run_migrations_online() -> None:
    # The app passes its own connection so migrations run on the event loop
    # that already exists. Spawning a second loop in a worker thread deadlocks
    # under uvloop, which uvicorn[standard] installs.
